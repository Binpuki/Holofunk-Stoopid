...
class FreeplayState extends MusicBeatState
{
	...
	public static var songDescriptions:Array<String> = [];
	...
	override function create()
	{
		...
		versionShit = new FlxText(5, FlxG.height + 40, 0, "Description - " + songDescriptions[curSelected], 12);
	...
	function changeSelection(change:Int = 0)
	{
		...
		trace(songDescriptions[curSelected]);
		versionShit.text = "Description - " + songDescriptions[curSelected];
	}
}
